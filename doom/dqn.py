...
Customizations specific to doom:
- imports for vizdoom
- make environment using DoomEnv()
...
- set GAMMA to 0.9
- added custom GrayScaleObservation wrapper because doom env doesn't provide proper observation_space.shape
- add TransformObservation wrapper to reorder axes
'''
...
#ENV = 'VizdoomGymHealthGathering-v0'
ENV = 'VizdoomGymHealthGatheringSupreme-v0'

#scenario = 'basic.cfg'
#scenario = 'deadly_corridor.cfg'
#scenario = 'health_gathering.cfg'
scenario = 'health_gathering_supreme.cfg'
...
SYNC_TARGET_MODEL_EVERY = 2_000  # how often (in steps) to copy weights to target model
...
EPS_DECAY_STEPS = 100_000  # over how many steps to linearly reduce epsilon until it reaches EPS_MIN
